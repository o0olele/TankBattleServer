#define NGX_CONFIGURE " --prefix=/data/nginx-1.10.1 --user=nginx --group=nginx --with-http_ssl_module --with-http_stub_status_module"
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/data/nginx-1.10.1/"
#endif
